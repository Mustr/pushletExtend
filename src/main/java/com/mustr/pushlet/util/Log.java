...
import com.mustr.pushlet.core.Config;
import com.mustr.pushlet.core.ConfigDefs;
...
public class Log implements ConfigDefs {
	...
	static public void init() {
		try {
			logger = (PushletLogger) Config.getClass(LOGGER_CLASS, "com.mustr.pushlet.util.DefaultLogger").newInstance();
		} catch (Throwable t) {
